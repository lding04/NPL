...
def train(args):
    ...
    if args.do_train and args.do_eval:
        ...
        print('训练代价：',train_spec)
        eval_spec = tf.estimator.EvalSpec(input_fn=eval_input_fn)
        eval_result, export_results = tf.estimator.train_and_evaluate(estimator, train_spec, eval_spec)
        print('验证集代价:',eval_result)
        print('验证评估:',export_results)
